class da_GUI_fontMainMenu extends GUIFont;
...
defaultproperties
{
     ...
     KeyName="DA2MainMenuFont"
     FallBackRes=640
     FontArrayNames(0)="DA2FontsDialog.DIN28"
     FontArrayNames(1)="DA2FontsDialog.DIN25"
     FontArrayNames(2)="DA2FontsDialog.DIN22"
     FontArrayNames(3)="DA2FontsDialog.DIN20"
     FontArrayNames(4)="DA2FontsDialog.DIN14"
     FontArrayNames(5)="DA2FontsDialog.DIN11"
}
