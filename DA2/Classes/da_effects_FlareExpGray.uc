class da_effects_FlareExpGray extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'DA2.da_effects_FlareExpGray.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         ColorScale(0)=(Color=(B=163,G=165,R=175))
         ColorScale(1)=(RelativeTime=0.100000,Color=(B=108,G=118,R=140,A=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=39,G=50,R=43))
         Opacity=0.800000
     ...
     End Object
     Emitters(1)=SpriteEmitter'DA2.da_effects_FlareExpGray.SpriteEmitter1'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter2
         ...
         ColorScale(2)=(RelativeTime=0.725000,Color=(B=140,G=151,R=168))
     ...
     End Object
     Emitters(2)=SpriteEmitter'DA2.da_effects_FlareExpGray.SpriteEmitter2'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter3
         ...
         LifetimeRange=(Min=1.400000,Max=3.000000)
     End Object
     Emitters(3)=SpriteEmitter'DA2.da_effects_FlareExpGray.SpriteEmitter3'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter4
         ...
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.600000,Color=(B=126,G=141,R=171,A=255))
         ...
         VelocityScale(0)=(RelativeTime=1.000000,RelativeVelocity=(X=0.200000,Y=0.200000,Z=0.200000))
     End Object
     Emitters(4)=SpriteEmitter'DA2.da_effects_FlareExpGray.SpriteEmitter4'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter41
         ...
         VelocityLossRange=(X=(Min=3.000000,Max=3.000000),Y=(Min=3.000000,Max=3.000000),Z=(Min=3.000000,Max=3.000000))
     End Object
     Emitters(5)=SpriteEmitter'DA2.da_effects_FlareExpGray.SpriteEmitter41'
