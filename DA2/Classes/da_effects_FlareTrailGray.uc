...
//
//-----------------------------------------------------------
class da_effects_FlareTrailGray extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter4
         ...
         ColorScale(1)=(RelativeTime=0.214286,Color=(B=179,G=183,R=196,A=255))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=104,G=107,R=117))
     ...
     End Object
     Emitters(0)=SpriteEmitter'DA2.da_effects_FlareTrailGray.SpriteEmitter4'
     ...
     End Object
     Emitters(1)=SpriteEmitter'DA2.da_effects_FlareTrailGray.SpriteEmitter35'
