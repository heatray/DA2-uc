...
class da_GUI_daStyle_Button extends GUI2Styles;

defaultproperties
{
     KeyName="DA2Style_Button"
     ...
     Images(0)=Texture'DA2GUI.Dialog.button_blurry'
     Images(1)=Texture'DA2GUI.Dialog.button_watched'
     Images(2)=Texture'DA2GUI.Dialog.button_focused'
     Images(3)=Texture'DA2GUI.Dialog.button_pressed'
     Images(4)=Texture'DA2GUI.Dialog.button_Disabled'
}
